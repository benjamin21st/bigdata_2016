...
# polygon stats
cd polygon
hfs -rm -r /user/mw3265/YellowPolygonResult_1_6
hfs -rm -r /user/mw3265/YellowPolygonResult_7_12

hjs -D mapreduce.job.reduces=4 -files map2.py,reduce.py -mapper map2.py -reducer reduce.py -input /user/mw3265/yellow_input/yellow_2015_01_poly.txt -input /user/mw3265/yellow_input/yellow_2015_02_poly.txt -input /user/mw3265/yellow_input/yellow_2015_03_poly.txt -input /user/mw3265/yellow_input/yellow_2015_04_poly.txt -input /user/mw3265/yellow_input/yellow_2015_05_poly.txt -input /user/mw3265/yellow_input/yellow_2015_06_poly.txt -output /user/mw3265/YellowPolygonResult_1_6
    
hjs -D mapreduce.job.reduces=4 -files map2.py,reduce.py -mapper map2.py -reducer reduce.py -input
/user/mw3265/yellow_input/yellow_2015_07_poly.txt -input /user/mw3265/yellow_input/yellow_2015_08_poly.txt -input /user/mw3265/yellow_input/yellow_2015_09_poly.txt -input /user/mw3265/yellow_input/yellow_2015_10_poly.txt -input /user/mw3265/yellow_input/yellow_2015_11_poly.txt -input /user/mw3265/yellow_input/yellow_2015_12_poly.txt -output /user/mw3265/YellowPolygonResult_7_12

hfs -get /user/mw3265/YellowPolygonResult_1_6
hfs -get /user/mw3265/YellowPolygonResult_7_12
cd ..
