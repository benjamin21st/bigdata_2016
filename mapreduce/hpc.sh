...
hfs -get /user/mw3265/YellowResult ../mapreduceresult/YellowResult
cd ..
...
hfs -get /user/mw3265/GreenResult ../mapreduceresult/GreenResult
cd ..
...
hfs -get /user/mw3265/YellowPolygonResult ../mapreduceresult/YellowPolygonResult
cd ..
...
hfs -get /user/mw3265/GreenPolygonResult ../mapreduceresult/GreenPolygonResult
cd ..
...
hfs -get /user/mw3265/YellowNghTripStatsMerge ../mapreduceresult/YellowNghTripStatsMerge
cd ..
...
hfs -get /user/mw3265/GreenNghTripStatsMerge ../mapreduceresult/GreenNghTripStatsMerge
cd ..
